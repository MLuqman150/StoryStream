    ...
    return (
        <div>
            ...
            <div className='flex justify-center sm:w-full md:w-[70%] items-center flex-row m-auto bg-[#D9EAFD] rounded-xl h-auto p-2'>
                <img src={bundeno} alt="bundeno" className='w-1/3 m-2 h-auto rounded-xl' />
                <div>
                ...
                <div className='flex m-2'> 
                    <BiLike className='mx-1 text-blue-700' />
                    <BiDislike className='mx-1 text-blue-700' />
                    <FaRegCommentAlt className='mx-1 text-blue-700' />
                    <CiShare2 className='mx-1 text-blue-700' />
                </div>
                </div>
            </div>
        </div>
